                    ...
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url('edulevels', $edulevel->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $edulevel->name ?? 'name'}}" autofocus required>
                            </div>
                            <div class="form-group">
                                <label>Keterangan</label>
                                <textarea name="desc" class="form-control" required>{{ $edulevel->desc ?? 'desc'}}</textarea>
                            </div>
